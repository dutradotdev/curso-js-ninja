(function(){
  ...
  */
  var five = Number(5); //new Number() é object, Number() (sem o new), serve para conversão
  ...
  */
  function isOperatorValid(operator) {
    ...
    /*
      Essa abordagem é muito melhor porque caso eu adicione mais operators no meu operation, eu não
      preciso mudar o return toda hora.
      O !! retorna o valor booleano associado a operation[operator]:
        caso o operator não exista, ele retorna undefined que é falsy
        caso o operator exista, o valor dele é uma funcao que retorna truthy
    */
  }
