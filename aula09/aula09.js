(function() {
  ...
  */
  ...
  `calculator`.
  E essa função espera um parâmetro `callback`. O `callback`
  ...
  */
  var substraction = calculator(5, 3);
  ...
  */
  ...
  console.log( 'O resultado da divisão é:', division(function(k, z) { return k / z }) );
  // ?

  console.log( 'O resto da divisão é:', mod(function(j, k) { return j % k }));
  // ?
