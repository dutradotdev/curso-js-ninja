(function(){
  ...
  */
  ...
  console.log(texto.replace(/Manuel Marques de Sousa/g, "Lucas Dutra!!"));
  ...
  */
 console.log(texto.replace(/brasileiro/g, "paulista"));
  // ?
  ...
  */
  ...
  console.log(texto.replace(/a|A/g, "0"));// podia ser /a/gi
  // ?
  ...
  */
  ...
  console.log(texto.replace(/O Centauro de Luvas/g, function(textoEncontrado) {
    return textoEncontrado.toUpperCase();
  }));
  ...
  */
  ...
  function getMonthNumber(month) {
    if(typeof month !== 'string') {
      return 'Entre com um argumento válido';
    }
  ...
  */
  console.log( '\nReplace de datas:' );
  console.log(texto.replace(regexDate, function(capturado, dd, mm, yy) {
    return dd + '/' + getMonthNumber(mm) + '/' + yy;
  }));
  // ?
}());
