(function() {
  ...
  */
  ...
  var fullName = 'lucas-muniz-dutra';
  console.log(fullName);
  const transformation = fullName.split('-').map(elm => {
  ...
  */
  ...
  var frase = amigos.reduce((acc, elm, i) => {
    console.log(elm, i)

    if (i === amigos.length - 1) {
      return acc + ' e ' + elm + ' são meus amigos.';
    }
    return acc + ', ' + elm;
  });
  // ?
  ...
  */
  console.log( '\nEra "Roberto", agora é:' );
  var nome = 'Roberto';
  console.log(nome.split('o').join('a').replace('a', 'o'));
