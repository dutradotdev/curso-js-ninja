(function(){
  ...
  */
  ...
  console.log(cleanCPF("735 500 794 - 22")) //73550079422
  console.log(cleanCPF("101.123-131x32")) // 10112313132
  ...
  */
  ...
  function formatCpf(cpf, grupo1, grupo2, grupo3, grupo4) {
    return `${grupo1}.${grupo2}.${grupo3}-${grupo4}`;
  }
  console.log('04921434211'.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, formatCpf));
